...
class TranslateConverter(PDFConverterEx):
    def __init__(
        ...
        for translator in [GoogleTranslator, BingTranslator, DeepLTranslator, DeepLXTranslator, OllamaTranslator, XinferenceTranslator, AzureOpenAITranslator,
                           OpenAITranslator, ZhipuTranslator, ModelScopeTranslator, SiliconTranslator, GeminiTranslator, AzureTranslator, TencentTranslator, DifyTranslator, FirefoxTranslator, AnythingLLMTranslator, ArgosTranslator, GrokTranslator, GroqTranslator, DeepseekTranslator, MiniMaxTranslator, OpenAIlikedTranslator, QwenMtTranslator, X302AITranslator]:
    ...
    def receive_layout(self, ltpage: LTPage):
        ...
        # The retry must be bounded: a translation that can never succeed (e.g.
        # an engine whose model cannot be loaded offline) has to surface as an
        # error instead of being retried forever, which would leave the job
        # stuck at whatever progress it had already reached.
